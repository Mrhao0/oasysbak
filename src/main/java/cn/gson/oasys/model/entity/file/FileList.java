...
public class FileList implements Serializable {
	...
	@ManyToOne
	@JoinColumn(name = "id_dir_management") //要审核的提交目录
	private DirManagement id_dir_management;
	...
	public DirManagement getId_dir_management() {
		return id_dir_management;
	}

	public void setId_dir_management(DirManagement id_dir_management) {
